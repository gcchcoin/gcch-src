...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("GCCH");
    case mBTC: return QString("mGCCH");
    case uBTC: return QString::fromUtf8("μGCCH");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("GCCHCoins"));
    case mBTC: return QString(QObject::tr("Milli-GCCHCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-GCCHCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
